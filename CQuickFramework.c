...
PHP_MINIT_FUNCTION(CQuickFramework)
{
	...
	CMYFRAME_REGISTER_CLASS(CDir);
	CMYFRAME_REGISTER_CLASS(CHttpResponse);
	CMYFRAME_REGISTER_CLASS(CHttp);
	CMYFRAME_REGISTER_CLASS(CMathModel);
	

#ifndef PHP_WIN32
	CMYFRAME_REGISTER_CLASS(CSecurityCode);
	CMYFRAME_REGISTER_CLASS(CMicroServer);
	CMYFRAME_REGISTER_CLASS(CTcpGateway);
	CMYFRAME_REGISTER_CLASS(CTcpServer);
	CMYFRAME_REGISTER_CLASS(CTcpClient);
	CMYFRAME_REGISTER_CLASS(CSocket);
	CMYFRAME_REGISTER_CLASS(CSocketClient);
...
#if CQUICKFRAMEWORK_USE_KAFKA
	CMYFRAME_REGISTER_CLASS(CKafka);
#endif
