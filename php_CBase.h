...
#define HOOKS_SAFE_STOP "HOOKS_SAFE_STOP"
#define HOOKS_BASH_BEFORE "HOOKS_BASH_BEFORE"
#define HOOKS_BASH_END "HOOKS_BASH_END"
#define HOOKS_CCONSUMER_MESSAGE_BEFORE "HOOKS_CCONSUMER_MESSAGE_BEFORE"
